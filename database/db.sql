...
--***** inventory table -- only typed code in vscode *****
...
--***** classification and inventory relationship -- only typed code in vscode *****
--link classification and inventory tables
ALTER TABLE IF EXISTS public.inventory
    ADD CONSTRAINT fk_classification FOREIGN KEY (classification_id)
    REFERENCES public.classification (classification_id) MATCH SIMPLE
    ON UPDATE CASCADE
    ON DELETE NO ACTION;
--***** account table -- only typed code in vscode *****
...
--***** Step 6 - Add The Data - not done -- only typed code in vscode *****
